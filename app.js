...
async function confirmBooking() {
    ...
    try {
        ...
        const waMessage = `Hola Carmen, acabo de agendar una cita para *${appointment.serviceEmoji} ${appointment.service}* el *${dayStr}* a las *${appointment.time}*. Mi nombre es *${appointment.clientName}*.`;
        const waUrl = `https://wa.me/5216623427752?text=${encodeURIComponent(waMessage)}`;
...
function showSuccess(appt) {
    ...
    const waMessage = `Hola Carmen, acabo de agendar una cita para *${appt.serviceEmoji} ${appt.service}* el *${dayStr}* a las *${appt.time}*. Mi nombre es *${appt.clientName}*.`;
    const waUrl = `https://wa.me/5216623427752?text=${encodeURIComponent(waMessage)}`;
